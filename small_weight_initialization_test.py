"""Investigating the effect small weight initialization has on MNIST 
performance."""
...
net2 = network_library.Network([784, 100, 100, 10], 0.6, 64, 
	cost_function=network_library.CrossEntropyCost)
	
# Compare both networks.
network_library.compare_net(net1, net2, training_data, training_labels,
	test_data, test_labels, 1000, 64, 'Small weights: ON ', 
	'Small weights: OFF')

print("---Done: Small Weight Initialization---")
