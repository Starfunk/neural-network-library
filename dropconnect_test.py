"""Investigating the effect DropConnect has on MNIST 
performance."""
...
net1 = network_library.Network([784, 800, 800, 10], 0.6, 64, 
	cost_function=network_library.CrossEntropyCost, small_weights=True)
	
# Instantiate the second neural network.
net2 = network_library.Network([784, 800, 800, 10], 0.6, 64, 
	cost_function=network_library.CrossEntropyCost, small_weights=True)
	
# Compare both networks.
network_library.compare_net(net1, net2, training_data, training_labels,
	test_data, test_labels, 2000, 64, 'DropConnect: ON ', 
	'DropConnect: OFF', dropconnect_test=True, L2=True, p = 0.7)
